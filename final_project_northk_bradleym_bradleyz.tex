...
\begin{table}[h!]
\caption{Byte Level Layout of a MAVLink packet}
\centering
...
\caption{Antenna of a 915MHz telemetry module}
\label{mavStruct}
\end{figure}
...
\hspace*{0cm}
\centering
\includegraphics[width=4in]{Scheduler.png}
\caption{Max B3}
\label{mavSched}
\end{figure}
...
\hspace*{0cm}
\centering
\includegraphics[width=4in]{GCS_Mavlink.png}
\caption{Max B4}
\label{gcsMav}
\end{figure}
...
\hspace*{0cm}
\centering
\includegraphics[width=4in]{Fallthrough.png}
\caption{Max B5}
\label{fallthrough}
\end{figure}
...
\hspace*{0cm}
\centering
\includegraphics[width=3.5in]{Version2.png}
\caption{Diagram of single microcontroller}
\label{version2}
\end{figure}
...
\bibitem{cuh4}
``Teensy v3.1 - 32 bit arduino-compatible microcontroller board," Velleman Spotlight. [Online]. Available: https://www.velleman.eu/products/view?id=420178. [Accessed: 06-Mar-2019].
...
\begin{IEEEbiographynophoto}{Max Bradley}
has no biography 
\end{IEEEbiographynophoto}
